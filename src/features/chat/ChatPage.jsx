...
const initial = [{ id: 'welcome', role: 'assistant', text: '안녕하세요! 여기는 채팅 실험실이에요. 메시지를 보내며 대화 UI를 테스트해보세요.' }];
